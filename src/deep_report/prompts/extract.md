...
9. **盈利质量维度**: 提取以下信息：
   - **一次性/非经常性项目**: 仅提取预计未来不会再发生的项目，逐项列出，标注金额和性质。
     * **包含**: 重大资产处置损益、重组费用、商誉/资产减值、法律和解金、政府罚款、自然灾害损失、收购相关费用
     * **排除**（这些是经常性项目，不要列入）: 利息收入/支出、常规汇兑损益、正常经营税费、"Other income/expense, net"中的经常性组成部分
